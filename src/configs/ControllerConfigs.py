...
class PPOControllerConfig(): 
    def __init__(self, config_dict: Dict[str, Union[Dict, str, float, int]], device: str) -> None:
        ...
        self.config_dict['actor_config']['actor_layers_sizes'] = [int(x) for x in config_dict['actor_config']['actor_layers_sizes'].values()]
        self.config_dict['critic_config']['critic_layers_sizes'] = [int(x) for x in config_dict['critic_config']['critic_layers_sizes'].values()]
